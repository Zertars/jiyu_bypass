...
# 教程正题
※请不要试图点击“卸载学生机房管理软件”/启动powershell&cmd&msconfig会遭到硬控。
1.下载release中的两个软件
2.运行tookits.exe
*请注意：保持toolkits.exe在桌面的最左上角。在完成所有步骤前（确保您不会受到jiyu&学生机房管理软件的控制）请不要关闭/隐藏toolkits.exe。若您不小心移动至其他位置，在控制状态下可以使用win唤出开始菜单短暂解除鼠标控制*
※toolkits使用Alt+B隐藏
3.点击toolkits.exe中的“解除鼠标限制”与“解除键盘限制”。此时电脑卡顿为正常现象
4.点击toolkits.exe中的“解除网络限制”，若成功执行，此时学生机房会强制全屏并提示“jiyu的两个重要进程不存在”。点击toolkits.exe中的”杀掉学生机房管理软件“，若成功执行，此时的强制全屏将会消失。
